...
exports.ResendPassMail = async (name, email, randomOtp) => {

   
    const emailTemplate = {
        from: '"MoviesAll" <your-email@gmail.com>',
        to: email,
        subject: "Password Reset Request - MoviesAll",
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                <div style="background-color: #16253D; padding: 30px; border-radius: 10px;">
                    <h1 style="color: #FF4500; margin: 0; padding-bottom: 20px;">MoviesAll</h1>
                    ...
                    <div style="background-color: #ffffff; padding: 30px; border-radius: 8px;">
                        <h2 style="color: #16253D; margin-top: 0;">Reset Your Password</h2>
                        <p style="color: #333333;">Hello ${name},</p>
                        <p style="color: #333333;">We received a request to reset your MoviesAll account password. Use the following verification code to proceed:</p>
                        ...
                        <ul style="color: #333333;">
                            ...
                            <li>This code will only be used for password reset purposes</li>
                            <li>If you didn't request this password reset, please ignore this email</li>
                        </ul>
                        
                        <p style="color: #333333; margin-top: 20px;">Need help? Contact our support team.<br>Team MoviesAll</p>
                    </div>
...
exports.AdminAuthOTP = async (name, email, randomOtp) => {

   
    const emailTemplate = {
        from: '"MoviesAll" <your-email@gmail.com>',
        to: email,
        subject: "Admin - MoviesAll",
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                <div style="background-color: #16253D; padding: 30px; border-radius: 10px;">
                    <h1 style="color: #FF4500; margin: 0; padding-bottom: 20px;">MoviesAll</h1>
